      ...
      <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="heading-1 mb-6 text-white">
            Transformamos
            <br />
            <span className="font-light">espaços em experiências</span>
          </h1>
        </motion.div>
        ...
        >
          Designer de interiores com mais de 7 anos de experiência criando
          ambientes únicos que refletem sua personalidade e estilo de vida.
        </motion.p>
